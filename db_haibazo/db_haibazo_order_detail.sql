...
CREATE TABLE `order_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKlanv50hmdot1n3le1ex3n9ehk` (`order_id`),
  ...
  CONSTRAINT `FKlanv50hmdot1n3le1ex3n9ehk` FOREIGN KEY (`order_id`) REFERENCES `us_order` (`id`)
...
INSERT INTO `order_detail` VALUES (1,1,1,1),(2,2,1,2),(3,1,2,3);
